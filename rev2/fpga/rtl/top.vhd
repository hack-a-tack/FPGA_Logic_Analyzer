...
-- i_LA0					1 bit		-> capture_engine (transmitted as 16-bit ANALYZER_INPUTS)
-- i_LA1					1 bit		-> capture_engine (transmitted as 16-bit ANALYZER_INPUTS)
-- i_LA2					1 bit		-> capture_engine (transmitted as 16-bit ANALYZER_INPUTS)
-- i_LA3					1 bit		-> capture_engine (transmitted as 16-bit ANALYZER_INPUTS)
-- i_LA4					1 bit		-> capture_engine (transmitted as 16-bit ANALYZER_INPUTS)
-- i_LA5					1 bit		-> capture_engine (transmitted as 16-bit ANALYZER_INPUTS)
-- i_LA6					1 bit		-> capture_engine (transmitted as 16-bit ANALYZER_INPUTS)
-- i_LA7					1 bit		-> capture_engine (transmitted as 16-bit ANALYZER_INPUTS)
-- i_LA8					1 bit		-> capture_engine (transmitted as 16-bit ANALYZER_INPUTS)
-- i_LA9					1 bit		-> capture_engine (transmitted as 16-bit ANALYZER_INPUTS)
-- i_LA10					1 bit		-> capture_engine (transmitted as 16-bit ANALYZER_INPUTS)
-- i_LA11					1 bit		-> capture_engine (transmitted as 16-bit ANALYZER_INPUTS)
-- i_LA12					1 bit		-> capture_engine (transmitted as 16-bit ANALYZER_INPUTS)
-- i_LA13					1 bit		-> capture_engine (transmitted as 16-bit ANALYZER_INPUTS)
-- i_LA14					1 bit		-> capture_engine (transmitted as 16-bit ANALYZER_INPUTS)
-- i_LA15					1 bit		-> capture_engine (transmitted as 16-bit ANALYZER_INPUTS)
